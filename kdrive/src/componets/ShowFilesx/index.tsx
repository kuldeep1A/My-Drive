...
export default function ShowFilesx({ parentId }: FolderStructure) {
  ...
  const handleSendEmail = () => {
    ...
    const mailtoLink = `https://mail.google.com/mail/?view=cm&fs=1&to=${encodeURIComponent(AdministratorEmail)}&su=${encodeURIComponent(subjectx)}&body=${encodeURIComponent(bodyx)}`;
